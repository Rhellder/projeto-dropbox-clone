class DropBoxController
{
    constructor()
    {
        ...
        this.btnInputFilesEl = document.querySelector("#files");
    ...
    connectFirebase()
    {
        ...
        var config = {
            apiKey: "AIzaSyDHyuKgQ46phHf8ednN0fnrhyueIwAo5WM",
            authDomain: "dropbox-clone-da4b2.firebaseapp.com",
            databaseURL: "https://dropbox-clone-da4b2.firebaseio.com",
            projectId: "dropbox-clone-da4b2",
            storageBucket: "dropbox-clone-da4b2.appspot.com",
            messagingSenderId: "168968449767"
          };
    ...
    initEvents()
    {
        this.btnSendFilesEl.addEventListener('click', event => {
            ...
            this.btnInputFilesEl.click();

        });

        this.btnInputFilesEl.addEventListener('change', event => {
